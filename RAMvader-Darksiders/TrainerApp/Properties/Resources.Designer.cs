...
namespace TrainerApp.Properties
{
	...
	public class Resources
	{
		...
		/// <summary>
		///   Looks up a localized string similar to example cheat&apos;s description!.
		/// </summary>
		public static string strChkCheatDescriptionExample
		{
			get
			{
				return ResourceManager.GetString( "strChkCheatDescriptionExample", resourceCulture );
			}
		}

		/// <summary>
		///   Looks up a localized string similar to Example cheat:.
		/// </summary>
		public static string strChkCheatPromptExample
		{
			get
			{
				return ResourceManager.GetString( "strChkCheatPromptExample", resourceCulture );
			}
		}
